<?php echo and_frm_start("/admin/ctr_templates/update", "and_ctr_templates");?>
<input type="hidden" name="id" value="<?php if(isset($id) && (int)$id>0) echo $id;?>">

<div class="shadow sm:overflow-hidden sm:rounded-md">
	<div class="bg-white px-4 py-5 sm:p-6">
		<div class="w-full">
			<?php echo and_frm_label(lang('Ctr_templates.name'), "name");?>
		...
		<div class="w-full mt-2">
			...
			<?php echo and_frm_checkbox("status", "Active", $checked, array("explain"=>lang('Ctr_templates.status_hint'))); ?>
		</div>
		<div class="w-full">
