...
<?php foreach ($rows as $key => $c):?>                        
  <tr>
    ...
    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
      <?php echo and_edit_link("/admin/ctr_templates/form/".$c->id, $c->name);?>
    </td>
    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
      <?php echo and_toggle_btn("/admin/ctr_templates/toggle/status/".$c->id, $c->status); ?>
    </td>
    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
      <?php echo and_edit_btn("/admin/ctr_templates/form/".$c->id, "Edit");?>
      <?php echo and_delete_btn("/admin/ctr_templates/delete/".$c->id, "Delete", "and_ctr_templates");?>
    </td>
  </tr>
<?php endforeach;?>
  </tbody>
