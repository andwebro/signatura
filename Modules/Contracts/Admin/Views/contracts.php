...
<?php echo admin_module_top('Contracts Manager 0.1');?>
<?php $this->endSection(); ?>
            ...
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
              ...
              <div class="flow-root p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <div class="float-left">
                    <?php echo admin_module_title('Contracts Manager');?>
                </div>
                <div class="float-right">
                    <?php echo header_menu_modal(lang('Contracts.add_new'), "", "/admin/contracts/form");?>
                    <?php echo header_menu_help("Contracts Manager", "contracts", 1);?>
                </div>
...
<form class="flex items-center js_module_search" id="js_module_search_box" data-target="and_contracts" data-action="/admin/contracts/search">
    ...
    <div class="relative">
        ...
        <input type="text" id="js_module_search_0" class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg block w-full pl-10" placeholder="Search" value="<?php if(isset($search) && isset($search["keyword"]) ) echo $search["keyword"];?>" name="keyword">
                    ...
                    <div id="and_contracts" class="js_module_list" data-action="/admin/contracts/list"></div>
